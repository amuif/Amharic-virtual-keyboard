...
import { AmharicKeyboard, useAmharicKeyboard } from './index';
...
function App() {
  ...
  useEffect(() => {
    // Add inputs using the ref method after component mounts
    const timer = setTimeout(() => {
      if (keyboardRef.current) {
        ...
        if (textareaRef.current) keyboardRef.current.addInput(textareaRef.current);
      }
    }, 100);
